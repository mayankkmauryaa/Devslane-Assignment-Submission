  ...
  return (
    <div className='border w-full border-gray-200 bg-white'>
      ...
      <div className='flex bg-gray-50 justify-between p-1'>
        ...
        <button onClick={onChangeCart} className={`rounded text-[12px] py-1 text-white px-4 mx-1 ${isDisable ? 'bg-[#FF5151] cursor-not-allowed opacity-70' : 'bg-[#FF5151] hover:cursor-pointer hover:bg-orange-500'
          } `}>UPDATE CART</button>
      </div>
    </div>
  )
